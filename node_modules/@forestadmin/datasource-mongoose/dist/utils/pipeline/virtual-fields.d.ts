...
export default class VirtualFieldsGenerator {
    static addVirtual(model: Model<unknown>, prefix: string, ignoredFields: string[], projection: Projection): PipelineStage[];
    static getVirtuals(path: string, schema: MongooseSchema, projection: Projection): Record<string, unknown>;
}
